...
public class TimBot {
    ...
    public TimBot( int id, int jolts ) {
        ...
        this.id = id;
        this.jolts = jolts;
        this.potentialBots = new boolean[5];
        this.potentialRipeness = new int[5];
        this.personality = "N";
    ...
    //This method returns the energy level (amount of jolts) of this TimBot.
    ...
    public void senseDistricts( int [] spresso, boolean [] bots ) {
        ...
        potentialBots[0] = bots[0]; //Current
        potentialBots[1] = bots[1]; //North
        potentialBots[2] = bots[2]; //East
        potentialBots[3] = bots[3]; //South
        potentialBots[4] = bots[4]; //West

        potentialRipeness[0] = spresso[0]; //Current
        potentialRipeness[1] = spresso[1]; //North
        potentialRipeness[2] = spresso[2]; //East
        potentialRipeness[3] = spresso[3]; //South
        potentialRipeness[4] = spresso[4]; //West
    ...
    public int getNextMove() {
        // This is the default behaviour for the base class.

...
/*
 * The following is the public (only) class of the program and contains all program code.
...
public class ImageRW {
    ...
    /*
     * The following method loads an image from a file specified by the filename.
    ...
    /*
     * The following method saves an image to a file specified by the filename.
    ...
    /*
     * The following method gets the pixel at location (x,y) and stores its three
    ...
    /*
     * The following method sets the pixel at location (x,y) from thre three
     * colour components in a three element array (rgb) that is passed as
     * one of the parameters.
     *
     * Parameters: x   : x coordinate of the pixel
    ...
    /*
     * The following method returns the height of the current image.
    ...
    /*
     * The following method returns the width of the current image.
     *
